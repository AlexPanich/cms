        ...
        <div class="sidebar-content">
            ...
            <div class="side-header side-content">
                ...
                <a class="h5 text-white" href="{{ route('index') }}">
                    <span>{{ $text->getByAlias('title')->body }}</span>
                </a>
            </div>
            <!-- END Side Header -->
            ...
            <div class="side-content">
                <ul class="nav-main">
                    <li>
                        <a class="active" href="{{ route('index') }}"><i class="si si-home"></i><span class="sidebar-mini-hide">Главная</span></a>
                    </li>
                    <li class="nav-main-heading"><span class="sidebar-mini-hide"></span></li>
                    <li>
                        <a href="{{ route('dashboard') }}"><i class="si si-wrench"></i><span class="sidebar-mini-hide">Панель управления</span></a>
                    </li>
                </ul>
            </div>
            <!-- END Side Content -->
